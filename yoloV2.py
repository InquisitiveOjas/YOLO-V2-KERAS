...
import scipy.io    #Input and output ( scipy.io ) SciPy has many modules, classes, and functions available to read data from and write data to a variety of file formats.
import scipy.misc  #Miscellaneous routines
import numpy as np
from PIL import Image #PIL:Python Image Library-The Image module provides a class with the same name which is used to represent a PIL image. The module also provides a number of factory functions, including functions to load images from files, and to create new images.
from keras import backend as K
from keras.models import load_model
from yolo_utils import read_classes, read_anchors, generate_colors, preprocess_image, draw_boxes
from yad2k.models.keras_yolo import yolo_head, yolo_eval #YAD2K is a 90% Keras/10% Tensorflow implementation of YOLO_v2.

#Provide the name of the image that you saved in the images folder to be fed through the network
input_image_name = "yoloimg.jpg"
